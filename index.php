...
<body>
  ...
  <main>
      ...
      <?php
        ...
        //Get playrate data
        $playcontents = file_get_contents('http://api.champion.gg/v2/champions?elo=PLATINUM&champData=playRate,winRate,banRate&sort=playRate-desc&limit=20&api_key='. $apiKey);
